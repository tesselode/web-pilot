...
class.phantom.point_value = 20

function class.phantom:new(web, entities)
	self.web = web
...
function class.phantom:collide(other)
	if other:is(class.player_bullet) then
		...
		self.movement_speed *= -1
		self.z -= .0075
		if self.z < self.web.min_z then self:die() end
	end
end
...
function state.gameplay:enter()
	...
	add(self.entities, class.phantom(self.web))
	self:init_stars()
	self.score = 0
...
__gfx__

